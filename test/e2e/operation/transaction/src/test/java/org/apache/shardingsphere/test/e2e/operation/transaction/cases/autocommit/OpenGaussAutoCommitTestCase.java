...
public final class OpenGaussAutoCommitTestCase extends AutoCommitTestCase {
    
    public OpenGaussAutoCommitTestCase(final TransactionTestCaseParameter testCaseParam) {
        super(testCaseParam);
    }
